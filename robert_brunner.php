    ...
    <div class="row">
      <div class="col-lg-5 col-md-6">
        ...
        <div class="mb-2 d-flex">
          <h4 class="font-weight-normal"><?='Robert Brunner  '?></h4>
        ...
        <div class="mb-2">
          <ul class="list-unstyled">
            <li class="media">
              ...
              <label class="media-body"><?='Linux Developer'?></label>
            </li>
            <li class="media">
              <span class="w-25 text-black font-weight-normal">Dream company: </span>
              <label class="media-body">KDE</label>
            </li>
            <li class="media">
              <span class="w-25 text-black font-weight-normal">Email: </span>
              <label class="media-body"><?='brunner.robert@protonmail.com'?></label>
            </li>
          </ul>
        </div>
      </div>
      <div class="col-lg-7 col-md-6 pl-xl-3">
        ...
        <p><?='I am working on my second bachelors degree at NKU, my first being a sociology major with a woman\'s 
        ...
        spending time with my many pets!'?></p>
        <div class="my-2 bg-light p-2">
          <p class="font-italic mb-0"><?='To light a candle is to cast a shadow. - Ursula K. Le Guin'?></p>
        </div>
